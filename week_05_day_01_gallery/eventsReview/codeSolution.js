...
// const myBox = document.querySelector('.tracker')

// myBox.addEventListener('dbclick', function () {
//   myBox.classList.toggle('roundy')
// })
...
myBox.addEventListener('click', event =>{
  myBox.setAttribute('style', 'background-color: #'+ Math.floor(Math.random()*1000) + ';')
})